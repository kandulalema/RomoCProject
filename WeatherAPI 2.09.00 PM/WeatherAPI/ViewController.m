...
- (IBAction)getWeatherConditions:(id)sender {
    ...
    [manager GET:urlString parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        NSString *urltext = [NSString stringWithFormat:@"%s%@", TextToSpeechURL, sentence];
        
        manager.responseSerializer = [AFHTTPResponseSerializer serializer];
        
        [manager GET:urltext parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
